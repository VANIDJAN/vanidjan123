...
int main(int argc, char *argv[])
{
    ...
    engine.rootContext()->setContextProperty("page5Text", readAndDisplayText("/home/zenov/untitled5/dmesg.txt"));
    engine.rootContext()->setContextProperty("page6Text", readAndDisplayText("/home/zenov/untitled5/algoritm.txt"));
